...
secondary_keywords:
  - "drip coffee maker vs single serve"
...
# Brief: Drip vs Single-Serve Coffee Maker (Phase 1.5 Refresh)

## Phase Alignment
- **Roadmap phase:** Phase 1.5 (Design System Backfill)
- **Why:** Legacy page needs full v2 standards alignment + product images
- **Do not create a net-new topic page.** This is a full rewrite of existing `posts/drip-vs-single-serve-coffee-maker.html`.

## Keyword Data + Search Intent Analysis

### Primary Keyword Cluster
- **Primary keyword:** drip vs single serve coffee maker
...
- Compare on brew speed, per-cup cost, cleanup, household fit. Help users decide which format fits their routine
...
- This is a full rewrite of existing `posts/drip-vs-single-serve-coffee-maker.html`
- Use styles-v2.css, full design system components
- Include real product images from Amazon CDN
- Maintain canonical URL: `https://coffeegearpicks.com/posts/drip-vs-single-serve-coffee-maker.html`
