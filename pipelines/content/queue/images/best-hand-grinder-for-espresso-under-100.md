...
- **Do not create a net-new topic page.** This is a full rewrite of existing `posts/best-hand-grinder-for-espresso-under-100.html`.

## Keyword Data + Search Intent Analysis

### Primary Keyword Cluster
- **Primary keyword:** best hand grinder for espresso under 100
...
- Differentiate by burr quality, dial-in control, grind effort, basket compatibility
...
- This is a full rewrite of existing `posts/best-hand-grinder-for-espresso-under-100.html`
- Use styles-v2.css, full design system components
- Include real product images from Amazon CDN
- Maintain canonical URL: `https://coffeegearpicks.com/posts/best-hand-grinder-for-espresso-under-100.html`
